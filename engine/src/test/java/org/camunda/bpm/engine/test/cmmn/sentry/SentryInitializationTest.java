...
public class SentryInitializationTest extends PluggableProcessEngineTestCase {
  ...
  public void testOnPart() {
    ...
    // then
    List<CaseSentryPart> parts = caseService
      .createCaseSentryPartQuery()
      .list();

    assertEquals(1, parts.size());

    CaseSentryPart part = parts.get(0);
  ...
  public void testOnPartAndIfPart() {
    ...
    CaseSentryPartQuery query = caseService.createCaseSentryPartQuery();

    assertEquals(2, query.count());

    CaseSentryPart part = query
