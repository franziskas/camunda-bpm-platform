 ...
 * @author Daniel Meyer
 */
public class StringValueSerializer extends PrimitiveValueSerializer<StringVariableValue> {

  public StringValueSerializer() {
    super(VariableType.STRING);
  }

  public StringVariableValue getValue(ValueFields valueFields) {
    return Variables.stringValue(valueFields.getTextValue());
  }

  public void setValue(StringVariableValue variableValue, ValueFields valueFields) {
