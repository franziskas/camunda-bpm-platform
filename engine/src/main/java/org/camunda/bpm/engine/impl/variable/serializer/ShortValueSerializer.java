 ...
 * @author Joram Barrez
 */
public class ShortValueSerializer extends PrimitiveValueSerializer<ShortVariableValue> {

  public ShortValueSerializer() {
    super(VariableType.SHORT);
  }

  public ShortVariableValue getValue(ValueFields valueFields) {
  ...
  public void setValue(ShortVariableValue value, ValueFields valueFields) {
