...
public interface TaskService {
   ...
   *
   * <p>
   * See {@link VariableType} for available variable types and their required
   ...
   * variable-type-specific and defined in {@link VariableType}.
   * @param variableTypeName Type of the variable to set. Defined in {@link VariableType}.
   * @param variableConfiguration Variable-type-specific configuration of the serialized value. Defined in {@link VariableType}.
