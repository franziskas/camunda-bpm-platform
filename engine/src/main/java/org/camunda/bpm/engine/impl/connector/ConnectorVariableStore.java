...
public class ConnectorVariableStore extends MapBasedVariableStore {
  ...
  public static class ConnectorParamVariable implements CoreVariableInstance {
    ...
    public ConnectorParamVariable(String name, VariableValue value) {
      this.name = name;
      this.value = value;
    }
  ...
  public void setVariableValue(CoreVariableInstance variableInstance, VariableValue value, AbstractVariableScope sourceActivityExecution) {
    ((ConnectorParamVariable)variableInstance).value = value;
  }

  public ConnectorParamVariable createVariableInstance(String variableName, VariableValue value, AbstractVariableScope sourceActivityExecution) {
