 ...
 * @author Daniel Meyer
 */
public class DateValueSerializer extends PrimitiveValueSerializer<DateVariableValue> {

  public DateValueSerializer() {
    super(VariableType.DATE);
  }

  public DateVariableValue getValue(ValueFields valueFields) {
  ...
  public void setValue(DateVariableValue value, ValueFields valueFields) {
    if (value!=null) {
