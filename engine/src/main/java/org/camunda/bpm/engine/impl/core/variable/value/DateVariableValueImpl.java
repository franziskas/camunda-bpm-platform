 ...
 *
 */
public class DateVariableValueImpl extends AbstractPrimitiveTypeValue<Date> implements DateVariableValue {

  private static final long serialVersionUID = 1L;

  public DateVariableValueImpl(Date value) {
    super(value, VariableType.DATE);
  }
