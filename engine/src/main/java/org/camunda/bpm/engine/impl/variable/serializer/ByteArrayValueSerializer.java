 ...
 * @author Daniel Meyer
 */
public class ByteArrayValueSerializer extends PrimitiveValueSerializer<BytesVariableValue> {

  public ByteArrayValueSerializer() {
    super(VariableType.BOOLEAN);
  }

  public BytesVariableValue getValue(ValueFields valueFields) {
    return Variables.byteArrayValue( getBytes(valueFields) );
  }

  public void setValue(BytesVariableValue variableValue, ValueFields valueFields) {
