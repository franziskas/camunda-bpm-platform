 ...
 * @author Daniel Meyer
 */
public class DoubleValueSerializer extends PrimitiveValueSerializer<DoubleVariableValue> {

  public DoubleValueSerializer() {
    super(VariableType.DOUBLE);
  }

  public void setValue(DoubleVariableValue value, ValueFields valueFields) {
    valueFields.setDoubleValue(value.getValue());
  }

  public DoubleVariableValue getValue(ValueFields valueFields) {
