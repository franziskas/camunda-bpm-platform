 ...
 *
 */
public abstract class ObjectVariableValueImpl extends AbstractVariableValue<Object> implements ObjectVariableValue {

  private static final long serialVersionUID = 1L;

  protected String serializationDataFormat;

  public ObjectVariableValueImpl(Object value) {
    super(value, VariableType.OBJECT);
  }
